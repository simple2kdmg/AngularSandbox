...
export class CustomSelectComponent implements OnChanges, ControlValueAccessor {
  @Input() data?: any[] | null;
  @Input() placeholder: string = 'Select item';
  @Input() valueField!: string;
  @Input() idField!: string;
  @Input() parentIdField?: string | null;
  ...
  public onSelectedChanges(nextSelectedNode: DropdownNode): void {
    this.dropdownOpened = false;
